...
- Removed the selected-day overlay create-mode toggle so it shows only Free/Busy range creation controls.
...
- `git diff --check` passed after removing the Free/busy vs Event toggle.
